...
import { MenuIcon, X as CloseIcon, Calendar, MapPin, Recycle, PersonStanding, Factory } from "lucide-react";
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <button className="mt-4 w-full py-2 bg-green-700 text-white rounded cursor-pointer font-medium hover:bg-green-800 transition-colors">
                    S&apos;inscrire
                  </button>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto group">
            ...
            <div className="bg-green-800 p-6 rounded-lg text-center relative">
              ...
              <h3 className="text-xl font-semibold mb-2 text-green-100">Production locale</h3>
      ...
      <section id="register" className="py-16 bg-green-50">
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-center text-green-800">Inscrivez-vous à notre événement</h2>
            {isFormSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full font-medium bg-green-700 text-white py-2 px-4 rounded-lg cursor-pointer hover:bg-green-800 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              <h3 className="text-2xl font-bold mb-4">SØMA</h3>
